...
write.table(abcd_stats_completetab, file = "abcd_stats_table.txt", sep = ",", quote = FALSE, row.names = FALSE)
...
(release_revmed_corrplot <- corrplot(as.matrix(release_pc_corrs), method = 'color', col = corr_color2(100), type = "full", p.mat = as.matrix(releaserev_pc_pvals), 
                              insig = "label_sig", cl.pos = "r", cl.cex = 1.5, pch.col = "black", pch.cex = 5, tl.pos = "n"))
dev.off()
