...
SociodemoVar_list <- data.table(c("White",
                         "Black",
                         "Hispanic",
                         "Asian",
                         "Other",
...
(enviropc_iconfig <- grid.arrange(homepc_icon, schoolpc_icon, neighborhoodpc_icon, culturepc_icon,  
                                     nrow = 1))
ggsave('enviropc_iconfig.png', enviropc_iconfig, height = 3, width = 5)

(neuroogpc_iconfig <- grid.arrange(neurocogpc1_icon, neurocogpc2_icon, neurocogpc3_icon,  
                                     nrow = 1))
...
rel1pc_corr <- cor(first_release_data[, c(86, 77:79, 76, 83:85)])
rel2pc_corr <- cor(second_release_data[, c(86, 77:79, 76, 83:85)])
...
rel1pc_corr_pvals <- cor.mtest(first_release_data[, c(86, 77:79, 76, 83:85)], method = "spearman")
rel2pc_corr_pvals <- cor.mtest(second_release_data[,  c(86, 77:79, 76, 83:85)], method = "spearman")
...
(pc_corrplot <- corrplot(relcombpc_corr, method = 'color', col = corr_color2(100), type = "full", addCoef.col = "black", number.cex = 2, diag = FALSE, cl.pos = "r", cl.cex = 1.8, tl.cex = 1.8, tl.col = "black", tl.srt = 0))
...
## glms for three cog BPPCs

```{r}
## General ability

genabil_rel1_model <- glm(Neurocog_BPPC1_GenAbility_resid ~ sociodemo_PC1_resid + home_PC1_resid + school_PC1_resid + neighborhood_PC1_resid +
                          culture_PC1_resid + sociodemo_PC1_resid:home_PC1_resid + sociodemo_PC1_resid:school_PC1_resid + 
                            sociodemo_PC1_resid:neighborhood_PC1_resid + sociodemo_PC1_resid:culture_PC1_resid, data = first_release_data)

genabil_rel2_model <- glm(Neurocog_BPPC1_GenAbility_resid ~ sociodemo_PC1_resid + home_PC1_resid + school_PC1_resid + neighborhood_PC1_resid +
                          culture_PC1_resid + sociodemo_PC1_resid:home_PC1_resid + sociodemo_PC1_resid:school_PC1_resid + 
                            sociodemo_PC1_resid:neighborhood_PC1_resid + sociodemo_PC1_resid:culture_PC1_resid, data = second_release_data)
## Executive functioning

execfunc_rel1_model <- glm(Neurocog_BPPC2_ExecFunc_resid ~ sociodemo_PC1_resid + home_PC1_resid + school_PC1_resid + neighborhood_PC1_resid +
                          culture_PC1_resid + sociodemo_PC1_resid:home_PC1_resid + sociodemo_PC1_resid:school_PC1_resid + 
                            sociodemo_PC1_resid:neighborhood_PC1_resid + sociodemo_PC1_resid:culture_PC1_resid, data = first_release_data)

execfunc_rel2_model <- glm(Neurocog_BPPC2_ExecFunc_resid ~ sociodemo_PC1_resid + home_PC1_resid + school_PC1_resid + neighborhood_PC1_resid +
                          culture_PC1_resid + sociodemo_PC1_resid:home_PC1_resid + sociodemo_PC1_resid:school_PC1_resid + 
                            sociodemo_PC1_resid:neighborhood_PC1_resid + sociodemo_PC1_resid:culture_PC1_resid, data = second_release_data)
  
## Learning/Memory 

learnmem_rel1_model <- glm(Neurocog_BPPC3_LearnMem_resid ~ sociodemo_PC1_resid + home_PC1_resid + school_PC1_resid + neighborhood_PC1_resid +
                          culture_PC1_resid + sociodemo_PC1_resid:home_PC1_resid + sociodemo_PC1_resid:school_PC1_resid + 
                            sociodemo_PC1_resid:neighborhood_PC1_resid + sociodemo_PC1_resid:culture_PC1_resid, data = first_release_data)

learnmem_rel2_model <- glm(Neurocog_BPPC3_LearnMem_resid ~ sociodemo_PC1_resid + home_PC1_resid + school_PC1_resid + neighborhood_PC1_resid +
                          culture_PC1_resid + sociodemo_PC1_resid:home_PC1_resid + sociodemo_PC1_resid:school_PC1_resid + 
                            sociodemo_PC1_resid:neighborhood_PC1_resid + sociodemo_PC1_resid:culture_PC1_resid, data = second_release_data)
...
## summary for general ability GLMs
```{r}
summary(genabil_rel1_model)

summary(genabil_rel2_model)
```

## summary for executive function GLMs
```{r}
summary(execfunc_rel1_model)

summary(execfunc_rel2_model)

```

## summary for learning/memory GLMs
```{r}
summary(learnmem_rel1_model)

summary(learnmem_rel2_model)
```

## GLMS for each environment separately 

```{r}
## General ability
genabil_homerel1_model <- glm(Neurocog_BPPC1_GenAbility_resid ~ sociodemo_PC1_resid*home_PC1_resid, data = first_release_data)
genabil_homerel2_model <-  glm(Neurocog_BPPC1_GenAbility_resid ~ sociodemo_PC1_resid*home_PC1_resid, data = second_release_data)

genabil_schoolrel1_model <- glm(Neurocog_BPPC1_GenAbility_resid ~ sociodemo_PC1_resid*school_PC1_resid, data = first_release_data)
genabil_schoolrel2_model <- glm(Neurocog_BPPC1_GenAbility_resid ~ sociodemo_PC1_resid*school_PC1_resid, data = second_release_data)

genabil_neighborhoodrel1_model <- glm(Neurocog_BPPC1_GenAbility_resid ~ sociodemo_PC1_resid*neighborhood_PC1_resid, data = first_release_data)
genabil_neighborhoodrel2_model <- glm(Neurocog_BPPC1_GenAbility_resid ~ sociodemo_PC1_resid*neighborhood_PC1_resid, data = second_release_data)

genabil_culturerel1_model <- glm(Neurocog_BPPC1_GenAbility_resid ~ sociodemo_PC1_resid*culture_PC1_resid, data = first_release_data)
genabil_culturerel2_model <- glm(Neurocog_BPPC1_GenAbility_resid ~ sociodemo_PC1_resid*culture_PC1_resid, data = second_release_data)


## Executive functioning
execfunc_homerel1_model <- glm(Neurocog_BPPC2_ExecFunc_resid ~ sociodemo_PC1_resid*home_PC1_resid, data = first_release_data)
execfunc_homerel2_model <- glm(Neurocog_BPPC2_ExecFunc_resid ~ sociodemo_PC1_resid*home_PC1_resid, data = second_release_data)

execfunc_schoolrel1_model <- glm(Neurocog_BPPC2_ExecFunc_resid ~ sociodemo_PC1_resid*school_PC1_resid, data = first_release_data)
execfunc_schoolrel2_model <- glm(Neurocog_BPPC2_ExecFunc_resid ~ sociodemo_PC1_resid*school_PC1_resid, data = second_release_data)

execfunc_neighborhoodrel1_model <- glm(Neurocog_BPPC2_ExecFunc_resid ~ sociodemo_PC1_resid*neighborhood_PC1_resid, data = first_release_data)
execfunc_neighborhoodrel2_model <- glm(Neurocog_BPPC2_ExecFunc_resid ~ sociodemo_PC1_resid*neighborhood_PC1_resid, data = second_release_data)

execfunc_culturerel1_model <- glm(Neurocog_BPPC2_ExecFunc_resid ~ sociodemo_PC1_resid*culture_PC1_resid, data = first_release_data)
execfunc_culturerel2_model <- glm(Neurocog_BPPC2_ExecFunc_resid ~ sociodemo_PC1_resid*culture_PC1_resid, data = second_release_data)
  
## Learning/Memory 
learnmem_homerel1_model <- glm(Neurocog_BPPC3_LearnMem_resid ~ sociodemo_PC1_resid*home_PC1_resid, data = first_release_data)
learnmem_homerel2_model <- glm(Neurocog_BPPC3_LearnMem_resid ~ sociodemo_PC1_resid*home_PC1_resid, data = second_release_data)

learnmem_schoolrel1_model <- glm(Neurocog_BPPC3_LearnMem_resid ~ sociodemo_PC1_resid*school_PC1_resid, data = first_release_data)
learnmem_schoolrel2_model <- glm(Neurocog_BPPC3_LearnMem_resid ~ sociodemo_PC1_resid*school_PC1_resid, data = second_release_data)

learnmem_neighborhoodrel1_model <- glm(Neurocog_BPPC3_LearnMem_resid ~ sociodemo_PC1_resid*neighborhood_PC1_resid, data = first_release_data)
learnmem_neighborhoodrel2_model <- glm(Neurocog_BPPC3_LearnMem_resid ~ sociodemo_PC1_resid*neighborhood_PC1_resid, data = second_release_data)

learnmem_culturerel1_model <- glm(Neurocog_BPPC3_LearnMem_resid ~ sociodemo_PC1_resid*culture_PC1_resid, data = first_release_data)
learnmem_culturerel2_model <- glm(Neurocog_BPPC3_LearnMem_resid ~ sociodemo_PC1_resid*culture_PC1_resid, data = second_release_data)

```


## summaries for each individual general ability glms
```{r}
summary(genabil_homerel1_model)
summary(genabil_homerel2_model)

summary(genabil_school_rel1_model)
summary(genabil_school_rel2_model)

summary(genabil_neighborhoodrel1_model)
summary(genabil_neighborhoodrel2_model)

summary(genabil_culturerel1_model)
summary(genabil_culturerel2_model)
```


## summaries for each individual executive functioning glms
```{r}
summary(execfunc_homerel1_model)
summary(execfunc_homerel2_model)

summary(execfunc_schoolrel1_model)
summary(execfunc_schoolrel2_model)

summary(execfunc_neighborhoodrel1_model)
summary(execfunc_neighborhoodrel2_model)

summary(execfunc_culturerel1_model)
summary(execfunc_culturerel2_model)
```

## summaries for each individual learning/memory glm
```{r}
summary(learnmem_homerel1_model)
summary(learnmem_homerel2_model)

summary(learnmem_schoolrel1_model)
summary(learnmem_schoolrel2_model)

summary(learnmem_neighborhoodrel1_model)
summary(learnmem_neighborhoodrel2_model)

summary(learnmem_culturerel1_model)
summary(learnmem_culturerel2_model)
```

## mixed effects models with participants nested within site as random intercepts
...
##Summary for General Ability mixed effects models
```{r}

summary(genabil_homerel1_mixmodel)
summary(genabil_homerel2_mixmodel)

summary(genabil_schoolrel1_mixmodel)
summary(genabil_schoolrel2_mixmodel)

summary(genabil_neighborhoodrel1_mixmodel)
summary(genabil_neighborhoodrel2_mixmodel)

summary(genabil_culturerel1_mixmodel)
summary(genabil_culturerel2_mixmodel)

```


## Summary for Exec Func mixed effects model
```{r}

summary(execfunc_homerel1_mixmodel)
summary(execfunc_homerel2_mixmodel)

summary(execfunc_schoolrel1_mixmodel)
summary(execfunc_schoolrel2_mixmodel)

summary(execfunc_neighborhoodrel1_mixmodel)
summary(execfunc_neighborhoodrel2_mixmodel)

summary(execfunc_culturerel1_mixmodel)
summary(execfunc_culturerel2_mixmodel)

```


## Summary for Learn/Mem mixed effects model
```{r}

summary(learnmem_homerel1_mixmodel)
summary(learnmem_homerel2_mixmodel)

summary(learnmem_schoolrel1_mixmodel)
summary(learnmem_schoolrel2_mixmodel)

summary(learnmem_neighborhoodrel1_mixmodel)
summary(learnmem_neighborhoodrel2_mixmodel)

summary(learnmem_culturerel1_mixmodel)
summary(learnmem_culturerel2_mixmodel)
...
rel1var_corr <- cor(first_release_data[, c(3:11, 19:55, 12:18, 65:67)])
rel2var_corr <- cor(second_release_data[, c(3:11, 19:55, 12:18, 65:67)])
...
rel1var_corr_pvals <- cor.mtest(first_release_data[, c(3:11, 19:55, 12:18, 65:67)], method = "spearman")
rel2var_corr_pvals <- cor.mtest(second_release_data[,  c(3:11, 19:55, 12:18, 65:67)], method = "spearman")
...
rownames(relcomb_corr) <- c("Age", "Male", "White", "Black", "Hispanic", "Asian", "Other Race", "Household Income", "Caregiver Education", "Family Conflict (Parent)",
...
colnames(relcomb_corr) <- c(rep(" ", 56))
...
## Visualize mediation effects and relationships between sociodemo PCs and Cog outcomes 
```{r}

## subset socio demoPCs from first and second rel and correlate 

rel1_pc_corr <- first_release_data %>%
  dplyr::select(sociodemo_PC1, sociodemo_PC1, sociodemo_PC1, sociodemo_PC1, Neurocog_BPPC1_GenAbility, Neurocog_BPPC2_ExecFunc, Neurocog_BPPC3_LearnMem) %>%
  cor()
...
rel1_revpc_corr <- first_release_data %>%
...
rel2_revpc_corr <- second_release_data %>%
  dplyr::select(home_PC1, school_PC1, neighborhood_PC1, culture_PC1, Neurocog_BPPC1_GenAbility, Neurocog_BPPC2_ExecFunc, Neurocog_BPPC3_LearnMem) %>%
  cor()
...
release_pc_corrs <- data.frame(rel1_BPPC1 = rep(rel1_pc_corr[1, 2],4), rel2_BPPC1 = rep(rel2_pc_corr[1, 2],4),
                               rel1_BPPC2 = rep(rel1_pc_corr[1, 3], 4), rel2_BPPC2 = rep(rel2_pc_corr[1, 3],4),
                               rel1_BPPC3 = rel1_pc_corr[1, 4], rel2_BPPC3 = rep(rel2_pc_corr[1, 4], 4))

releaserev_pc_corrs <- data.frame(rel1_BPPC1 = rel1_revpc_corr[1:4, 5], rel2_BPPC1 = rel2_revpc_corr[1:4, 5],
                               rel1_BPPC2 = rel1_revpc_corr[1:4, 6], rel2_BPPC2 = rel2_revpc_corr[1:4, 6],
                               rel1_BPPC3 = rel1_revpc_corr[1:4, 7], rel2_BPPC3 = rel2_revpc_corr[1:4,7])
...
png("release_standmed_corrplot.png", res = 600, width = 10000, height = 6000)
(release_standmed_corrplot <- corrplot(as.matrix(release_pc_corrs), method = 'color', col = corr_color2(100), type = "full", p.mat = as.matrix(release_pc_pvals), 
                              insig = "label_sig", cl.pos = "r", cl.cex = 1.5, pch.col = "black", pch.cex = 5, tl.pos = "n"))
dev.off()

png("release_standmed_corrplot_nosig.png", res = 600, width = 10000, height = 6000)
(release_standmed_corrplot_nosig <- corrplot(as.matrix(release_pc_corrs), method = 'color', col = corr_color2(100), type = "full", 
                                             cl.pos = "r", cl.cex = 1.5, tl.pos = "n"))
dev.off()

png("release_revmed_corrplot.png", res = 600, width = 10000, height = 6000)
(release_revmed_corrplot <- corrplot(as.matrix(releaserev_pc_corrs), method = 'color', col = corr_color2(100), type = "full", p.mat = as.matrix(releaserev_pc_pvals), 
                              insig = "label_sig", cl.pos = "r", cl.cex = 1.5, pch.col = "black", pch.cex = 5, tl.pos = "n"))
dev.off()

png("release_revmed_corrplot_nosig.png", res = 600, width = 10000, height = 6000)
(release_revmed_corrplot_nosig <- corrplot(as.matrix(releaserev_pc_corrs), method = 'color', col = corr_color2(100), type = "full",
                                           cl.pos = "r", cl.cex = 1.5, tl.pos = "n"))
dev.off()
