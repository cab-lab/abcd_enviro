...
relcomb_corr[lower.tri(relcomb_corr)] <- lower.tri(rel1var_corr)
relcomb_corr[relcomb_corr] <- upper.tri(rel2var_corr)
diag(relcomb_corr) <-  0
...
relcom_corr_pvals[lower.tri(relcom_corr_pvals)] <- lower.tri(rel1var_corr_pvals$p)
relcom_corr_pvals[upper.tri(relcom_corr_pvals)] <- upper.tri(rel2var_corr_pvals$p)
diag(relcom_corr_pvals) <- 0

png("relcom_corrplot.png", res = 600, width = 14000, height = 14000)
variable_corrplot <- corrplot(relcomb_corr, method = 'color', type = "full", diag = FALSE, p.mat = relcom_corr_pvals, 
