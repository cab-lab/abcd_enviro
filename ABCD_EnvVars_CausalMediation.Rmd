...
Y <- as.matrix(first_release_data[c("culture_PC1", "home_PC1", "school_PC1", "neighborhood_PC1", "neurocog_PC1", "neurocog_PC2",
...
first_release_data <- first_release_data %>%
  mutate(culture_PC1 = CombMeasures_allcog_resid[,"culture_PC1"],
         home_PC1 = CombMeasures_allcog_resid[,"home_PC1"],
         school_PC1 = CombMeasures_allcog_resid[,"school_PC1"],
         neighborhood_PC1 = CombMeasures_allcog_resid[,"neighborhood_PC1"],
         neurocog_PC1 = CombMeasures_allcog_resid[,"neurocog_PC1"],
         neurocog_PC2 = CombMeasures_allcog_resid[,"neurocog_PC2"],
         neurocog_PC3 = CombMeasures_allcog_resid[,"neurocog_PC3"],
         Neurocog_BPPC1_GenAbility = CombMeasures_allcog_resid[,"Neurocog_BPPC1_GenAbility"],
         Neurocog_BPPC2_ExecFunc = CombMeasures_allcog_resid[,"Neurocog_BPPC2_ExecFunc"],
         Neurocog_BPPC3_LearnMem = CombMeasures_allcog_resid[,"Neurocog_BPPC3_LearnMem"])

first_release_resid <- first_release_data %>%
  dplyr::select(subject_id, abcd_site, culture_PC1, home_PC1, school_PC1, neighborhood_PC1, 
...
Y <- as.matrix(second_release_data[c("culture_PC1", "home_PC1", "school_PC1", "neighborhood_PC1", "neurocog_PC1", "neurocog_PC2",
                                    "neurocog_PC3", "Neurocog_BPPC1_GenAbility", "Neurocog_BPPC2_ExecFunc", "Neurocog_BPPC3_LearnMem")])
