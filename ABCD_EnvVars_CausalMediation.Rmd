...
library(mediation); library(data.table); library(corrplot); library(easystats); library(dplyr); library(Hmisc)
...
abcd_data <- abcd_data %>% 
  ...
  mutate(age = age/12,
         male = as.numeric(factor(female, levels = c("no", "yes"), labels = c(1, 0))),
...
site_list[1:n_sites] <- as.character(unique(abcd_data_final$abcd_site))
...
# full_sample_data <- full_sample_data %>%
#   dplyr::select(subject_id, culture_PC1, home_PC1, school_PC1, neighborhood_PC1, sociodemo_PC1,
#                 neurocog_PC1, neurocog_PC2, neurocog_PC3, Neurocog_BPPC1_GenAbility, 
...
## Compare BPPCA results for neurocognitive scores for imputed and complete cases
...
## Plot distribution of weights for BPPCAs in complete case and imputed results

```{r}
# histogram for loadings separated by complete case and imputed participants 
...
full3_home_demenviro_patha <- lm(home_PC1 ~ sociodemo_PC1, data = second_release_data)
summary(full3_home_demenviro_patha)

full3_home_envirocog_pathb <- lm(Neurocog_BPPC3_LearnMem ~ sociodemo_PC1 + home_PC1, data = second_release_data)
summary(full3_home_envirocog_pathb)
...
## Site Split 1 mediation

### Site Split 1 Home Environment and BPPCA 1 

### Site Split 1 Home Environment and BPPCA 2 

### Site Split 1 Home Environment and BPPCA 3 

### Site Split 1 School Environment and BPPCA 1

### Site Split 1 School Environment and BPPCA 2

### Site Split 1 School Environment and BPPCA 3

### Site Split 1 Neighborhood Environment and BPPCA 1

### Site Split 1 Neighborhood Environment and BPPCA 2

### Site Split 1 Neighborhood Environment and BPPCA 3

### Site Split 1 Culture Environment and BPPCA 1

### Site Split 1 Culture Environment and BPPCA 2

### Site Split 1 Culture Environment and BPPCA 3

## Site Split 2 Mediation

### Site Split 2 Home Environment and BPPCA 1 

### Site Split 2 Home Environment and BPPCA 2 

### Site Split 2 Home Environment and BPPCA 3 

### Site Split 2 School Environment and BPPCA 1

### Site Split 2 School Environment and BPPCA 2

### Site Split 2 School Environment and BPPCA 3

### Site Split 2 Neighborhood Environment and BPPCA 1

### Site Split 2 Neighborhood Environment and BPPCA 2

### Site Split 2 Neighborhood Environment and BPPCA 3

### Site Split 2 Culture Environment and BPPCA 1

### Site Split 2 Culture Environment and BPPCA 2

### Site Split 2 Culture Environment and BPPCA 3
