...
Code for:                                                                                               
  1. Importing DEAP ABCD RDS file ('nda2.0.1.Rds') available for download on Midway2 
            (/project2/abcd/Release2.0.1_Files/DEAP_RDS_2.0.1/release2rds/results/ABCD_release2.0.1_update_Rds.zip)                                                        
  2. Gathering and cleaning relevant environment, sociodemographic, and neurocognitive BPPCAs           
          - for details on BPPCA, see Thompson et al., (2019). (https://www.sciencedirect.com/science/article/pii/S1878929318301622)                           
  3. Computing environment, sociodemographic, amd cognitive PCs for release and site split subsamples   
  
  4. Generating three mixed-effects models for the Thompson BPPC cognitive factors
  
  5. Supplementary analyses relating site split PCs, re-analyzing using natural log transformed income data, distributions of variable scores
...
```{r}
full_data <- read_rds("~/Documents/data/release2rds/results/ABCD_release2.0.1_update_Rds/nda2.0.1.Rds")
