...
sink("abcd_missing_table_rel1.txt")
print(summary(abcd_stats_totaltab_rel1), quote = FALSE, noSpaces = TRUE, printToggle = FALSE)
sink()

test <- data.frame(unclass(summary(abcd_stats_totaltab_rel1)), check.names = FALSE, stringsAsFactors = FALSE)

abcd_stats_totaltab_rel2 <- CreateTableOne(data = abcd_stats_total_rel2)
abcd_stats_summarytab_rel2 <- summary(abcd_stats_totaltab_rel2)
write.csv(abcd_stats_summarytab_rel2, file = "abcd_missing_table_rel2.csv")
...
(rel1_neurocog1_pccontrib_plot <- rel1_neurocog1_pccontrib %>%
                ggplot(aes(x = reorder(Variable, Contribution), y = Contribution)) +
                geom_bar(stat = "identity", position = "dodge", fill = color_cog) +
    scale_y_continuous(limits = c(-35, 45)) +
                coord_flip() +
                pc_theme )
...
(cor.test(full_sample_data$neurocog_PC1, full_sample_data$Neurocog_BPPC1_GenAbility, method = "spearman"))

# culture 
site_culture_corr <- diag(cor(site1_culture_varload, site2_culture_varload, method = "pearson"))

#site_culture_corr_pval <- cor.mtest(site1_culture_varload, site2_culture_varload, method = "pearson")

# home 
site_home_corr <- cor(site1_home_varload, site2_home_varload, method = "pearson")

#site_home_corr_pval <- cor.mtest(site1_home_varload, site2_home_varload, method = "pearson")

#school
site1_school_corr <- cor(site1_school_varload, method = "pearson")
site2_school_corr <- cor(site2_school_varload, method = "pearson")

site1_school_corr_pval <- cor.mtest(site1_school_varload, method = "pearson")
site2_school_corr_pval <- cor.mtest(site2_school_varload, method = "pearson")

#neighborhood
site1_neighborhood_corr <- cor(site1_neighborhood_varload, method = "pearson")
site2_neighborhood_corr <- cor(site2_neighborhood_varload, method = "pearson")

site1_neighborhood_corr_pval <- cor.mtest(site1_neighborhood_varload, method = "pearson")
site2_neighborhood_corr_pval <- cor.mtest(site2_neighborhood_varload, method = "pearson")

#sociodemo
site1_sociodemo_corr <- cor(site1_sociodemo_varload, method = "pearson")
site2_sociodemo_corr <- cor(site2_sociodemo_varload, method = "pearson")

site1_sociodemo_corr_pval <- cor.mtest(site1_sociodemo_varload, method = "pearson")
site2_sociodemo_corr_pval <- cor.mtest(site2_sociodemo_varload, method = "pearson")

##### average correlation coef for site split variable loadings #####
#culture
site1_culture_corr_avg <- mean(site1_culture_corr[lower.tri(site1_culture_corr)])
c(site1_culture_corr_avg, max(site1_culture_corr_pval$p[lower.tri(site1_culture_corr_pval$p)]), 
  min(site1_culture_corr_pval$p[lower.tri(site1_culture_corr_pval$p)]))

site2_culture_corr_avg <- mean(site2_culture_corr[lower.tri(site2_culture_corr)])
c(site2_culture_corr_avg, max(site2_culture_corr_pval$p[lower.tri(site2_culture_corr_pval$p)]), 
  min(site2_culture_corr_pval$p[lower.tri(site2_culture_corr_pval$p)]))

#home
site1_home_corr_avg <- mean(site1_home_corr[lower.tri(site1_home_corr)])
c(site1_home_corr_avg, max(site1_home_corr_pval$p[lower.tri(site1_home_corr_pval$p)]), 
  min(site1_home_corr_pval$p[lower.tri(site1_home_corr_pval$p)]))

site2_home_corr_avg <- mean(site2_home_corr[lower.tri(site2_home_corr)])
c(site2_home_corr_avg, max(site2_home_corr_pval$p[lower.tri(site2_home_corr_pval$p)]), 
  min(site2_home_corr_pval$p[lower.tri(site2_home_corr_pval$p)]))

#school
site1_school_corr_avg <- mean(site1_school_corr[lower.tri(site1_school_corr)])
c(site1_school_corr_avg, max(site1_school_corr_pval$p[lower.tri(site1_school_corr_pval$p)]), 
  min(site1_school_corr_pval$p[lower.tri(site1_school_corr_pval$p)]))

site2_school_corr_avg <- mean(site2_school_corr[lower.tri(site2_school_corr)])
c(site2_school_corr_avg, max(site2_school_corr_pval$p[lower.tri(site2_school_corr_pval$p)]), 
  min(site2_school_corr_pval$p[lower.tri(site2_school_corr_pval$p)]))

#neighborhood
site1_neighborhood_corr_avg <- mean(site1_neighborhood_corr[lower.tri(site1_neighborhood_corr)])
c(site1_neighborhood_corr_avg, max(site1_neighborhood_corr_pval$p[lower.tri(site1_neighborhood_corr_pval$p)]), 
  min(site1_neighborhood_corr_pval$p[lower.tri(site1_neighborhood_corr_pval$p)]))

site2_neighborhood_corr_avg <- mean(site2_neighborhood_corr[lower.tri(site2_neighborhood_corr)])
c(site2_neighborhood_corr_avg, max(site2_neighborhood_corr_pval$p[lower.tri(site2_neighborhood_corr_pval$p)]), 
  min(site2_neighborhood_corr_pval$p[lower.tri(site2_neighborhood_corr_pval$p)]))

#sociodemo
site1_sociodemo_corr_avg <- mean(site1_sociodemo_corr[lower.tri(site1_sociodemo_corr)])
c(site1_sociodemo_corr_avg, max(site1_sociodemo_corr_pval$p[lower.tri(site1_sociodemo_corr_pval$p)]), 
  min(site1_sociodemo_corr_pval$p[lower.tri(site1_sociodemo_corr_pval$p)]))

site2_sociodemo_corr_avg <- mean(site2_sociodemo_corr[lower.tri(site2_sociodemo_corr)])
c(site2_sociodemo_corr_avg, max(site2_sociodemo_corr_pval$p[lower.tri(site2_sociodemo_corr_pval$p)]), 
  min(site2_sociodemo_corr_pval$p[lower.tri(site2_sociodemo_corr_pval$p)]))
...
#corrRect(c(7, 4, 3, 30, 7, 3), lwd = 6)
dev.off()

```

## Project release 1 and release 2 participants through other PC
```{r}
...
#rel_projcomb_corr_pvals <- cor.test(rel1_PC_projcomb$neighborhood_PC1, rel2_PC_projcomb$neighborhood_PC1, method = "spearman")
...
# rownames(relcombpc_corr) <- c("Sociodemographic PC1", "Home Environment PC1", "School Environment PC1", 
#                               "Neighborhood Environment PC1", "Culture Environment PC1", "General Ability BPPC", "Executive Function BPPC",
#                               "Learning/Memory BPPC")
...
# 4. Fit mixed effects models with study site and family as random effect
...
##  summary of MEMs with random effect for family added
```{r}
...
(genabil_rel1_interplot <- plot_model(genabil_rel1_mixmodel_fam, type = "pred", terms = c("sociodemo_PC1_resid [-6:6]", "neighborhood_PC1_resid")) +
  theme_blank() +
...
(genabil_rel2_interplot_legend <- plot_model(genabil_rel2_mixmodel_fam, type = "eff", terms = c("sociodemo_PC1_resid [-6:6]", "neighborhood_PC1_resid")) +
  theme_blank() +
    xlab("Sociodemographic Component Score") +
    ylab("General Cognitive Ability Component Score") +
...
(sociodemo_figs[[1]] <- figure_data %>%
  ggplot(., aes(race_ethnicity, group = factor(release), fill = factor(release), alpha = factor(release))) +
    geom_bar(stat = "count", position = "dodge", color = "grey") +
    theme_classic() +
    scale_fill_manual(values = c("#EBF094", "#EBF094")) +
    scale_alpha_discrete(range = c(2, 0.45)) + 
    ylim(0, 3000) +
...
(sociodemo_figs[[2]] <- figure_data %>%
  ggplot(., aes(factor(Income), group = factor(release), fill = factor(release), alpha = factor(release))) +
    geom_bar(stat = "count", position = "dodge", color = "grey") +
    theme_classic() +
    scale_fill_manual(values = c("#EBF094", "#EBF094")) +
    scale_alpha_discrete(range = c(2, 0.45)) + 
...
(sociodemo_figs[[3]] <- figure_data %>%
  ggplot(., aes(factor(Education), group = factor(release), fill = factor(release), alpha = factor(release))) +
    geom_bar(stat = "count", position = "dodge", color = "grey") +
    theme_classic() +
    scale_fill_manual(values = c("#EBF094", "#EBF094")) +
    scale_alpha_discrete(range = c(2, 0.45)) +
...
(sociodemo_histfig <- grid.arrange(sociodemo_figs[[1]], sociodemo_figs[[2]], sociodemo_figs[[3]],
                                     heights = c(1, 1, 1),
                                     nrow = 3))
...
#### Home environment histograms 
```{r}
# (sociodemo_figs_arrange <- grid.arrange(grobs = sociodemo_figs, ncol = 2) )
# ggsave('sociodemo_figs.png', sociodemo_figs_arrange, height = 9, width = 13)

##### Home #####
home_figs <- list()

(home_figs[[1]] <- figure_data %>%
  ggplot(., aes(ParentAcceptance, group = factor(release), fill = factor(release), alpha = factor(release))) +
    geom_bar(stat = "count", position = "dodge", color = "grey") +
    theme_classic() +
    scale_fill_manual(values = c("#B1D8B7", "#B1D8B7")) +
    scale_alpha_discrete(range = c(2, 0.45)) ) 
    # ylim(0, 3000) +
    # theme(axis.title.x = element_blank(),
    #       axis.title.y = element_blank(),
...
(home_figs[[2]] <- figure_data %>%
  ggplot(., aes(ParentMonitoring, group = factor(release), fill = factor(release), alpha = factor(release))) +
...
(home_figs[[3]] <- figure_data %>%
  ggplot(., aes(FamConflict_P, group = factor(release), fill = factor(release), alpha = factor(release))) +
    geom_bar(stat = "count", position = "dodge", color = "grey") +
    theme_classic() +
    scale_fill_manual(values = c("#B1D8B7", "#B1D8B7")) +
    scale_alpha_discrete(range = c(2, 0.45)) ) 
...
(home_figs[[4]] <- figure_data %>%
  ggplot(., aes(FamConflict_Y, group = factor(release), fill = factor(release), alpha = factor(release))) +
...
(home_histfig <- grid.arrange(home_figs[[1]], home_figs[[2]], home_figs[[3]], home_figs[[4]],
                                     heights = c(1, 1),
                                     nrow = 2))
...
(school_figs[[1]] <- figure_data %>%
  ggplot(., aes(SchoolInvolvement, group = factor(release), fill = factor(release), alpha = factor(release))) +
    geom_bar(stat = "count", position = "dodge", color = "grey") +
    theme_classic() +
    scale_fill_manual(values = c("#7CC644", "#7CC644")) +
    scale_alpha_discrete(range = c(2, 0.45)) ) 
    # ylim(0, 3000) +
    # theme(axis.title.x = element_blank(),
    #       axis.title.y = element_blank(),
...
(school_figs[[2]] <- figure_data %>%
  ggplot(., aes(SchoolEnvironment, group = factor(release), fill = factor(release), alpha = factor(release))) +
    geom_bar(stat = "count", position = "dodge", color = "grey") +
    theme_classic() +
    scale_fill_manual(values = c("#7CC644", "#7CC644")) +
    scale_alpha_discrete(range = c(2, 0.45)) ) 
...
(school_figs[[3]] <- figure_data %>%
  ggplot(., aes(SchoolDisengagement, group = factor(release), fill = factor(release), alpha = factor(release))) +
    geom_bar(stat = "count", position = "dodge", color = "grey") +
    theme_classic() +
    scale_fill_manual(values = c("#7CC644", "#7CC644")) +
    scale_alpha_discrete(range = c(2, 0.45)) ) 
...
(school_histfig <- grid.arrange(school_figs[[1]], school_figs[[2]], school_figs[[3]],
                                     heights = c(1, 1, 1),
                                     nrow = 3))
...
(neighborhood_figs[[1]] <- figure_data %>%
  ggplot(., aes(ADI_PercFamPoverty, group = factor(release), fill = factor(release), alpha = factor(release))) +
    geom_bar(stat = "count", position = "dodge", color = "grey") +
    theme_classic() +
    scale_fill_manual(values = c("#16A637", "#16A637")) +
    scale_alpha_discrete(range = c(2, 0.45)) ) 
    # ylim(0, 3000) +
    # theme(axis.title.x = element_blank(),
    #       axis.title.y = element_blank(),
...
(neighborhood_figs[[2]] <- figure_data %>%
  ggplot(., aes(ADI_PercPovBelow138, group = factor(release), fill = factor(release), alpha = factor(release))) +
    geom_bar(stat = "count", position = "dodge", color = "grey") +
    theme_classic() +
    scale_fill_manual(values = c("#16A637", "#16A637")) +
    scale_alpha_discrete(range = c(2, 0.45)) ) 
...
(neighborhood_figs[[3]] <- figure_data %>%
  ggplot(., aes(ADI_PercSingle, group = factor(release), fill = factor(release), alpha = factor(release))) +
    geom_bar(stat = "count", position = "dodge", color = "grey") +
    theme_classic() +
    scale_fill_manual(values = c("#16A637", "#16A637")) +
    scale_alpha_discrete(range = c(2, 0.45)) ) 
...
(neighborhood_figs[[4]] <- figure_data %>%
  ggplot(., aes(ADI_IncDisparityIdx, group = factor(release), fill = factor(release), alpha = factor(release))) +
    geom_bar(stat = "count", position = "dodge", color = "grey") +
    theme_classic() +
    scale_fill_manual(values = c("#16A637", "#16A637")) +
    scale_alpha_discrete(range = c(2, 0.45)) ) 
...
(neighborhood_figs[[5]] <- figure_data %>%
  ggplot(., aes(ADI_MedianFamInc, group = factor(release), fill = factor(release), alpha = factor(release))) +
    geom_bar(stat = "count", position = "dodge", color = "grey") +
    theme_classic() +
    scale_fill_manual(values = c("#16A637", "#16A637")) +
    scale_alpha_discrete(range = c(2, 0.45)) ) 
...
(neighborhood_figs[[6]] <- figure_data %>%
  ggplot(., aes(ADI_PercHOwner, group = factor(release), fill = factor(release), alpha = factor(release))) +
    geom_bar(stat = "count", position = "dodge", color = "grey") +
    theme_classic() +
    scale_fill_manual(values = c("#16A637", "#16A637")) +
    scale_alpha_discrete(range = c(2, 0.45)) ) 
...
(neighborhood_figs[[7]] <- figure_data %>%
  ggplot(., aes(ADI_Edu_HSDip, group = factor(release), fill = factor(release), alpha = factor(release))) +
    geom_bar(stat = "count", position = "dodge", color = "grey") +
    theme_classic() +
    scale_fill_manual(values = c("#16A637", "#16A637")) +
    scale_alpha_discrete(range = c(2, 0.45)) ) 
...
(neighborhood_histfig <- grid.arrange(neighborhood_figs[[1]], neighborhood_figs[[2]], neighborhood_figs[[3]],
                                      neighborhood_figs[[4]], neighborhood_figs[[5]], neighborhood_figs[[6]],
                                      neighborhood_figs[[7]],
                                     heights = c(1, 1, 1, 1),
                                     nrow = 4))

ggsave('neighborhood_hist.png', neighborhood_histfig, height = 17, width = 10)
...
(culture_figs[[1]] <- figure_data %>%
  ggplot(., aes(EthIdentExploration, group = factor(release), fill = factor(release), alpha = factor(release))) +
    geom_bar(stat = "count", position = "dodge", color = "grey") +
    theme_classic() +
    scale_fill_manual(values = c("#116530", "#116530")) +
    scale_alpha_discrete(range = c(2, 0.45)) ) 
    # ylim(0, 3000) +
    # theme(axis.title.x = element_blank(),
    #       axis.title.y = element_blank(),
...
(culture_figs[[2]] <- figure_data %>%
  ggplot(., aes(EthIdentCommitment, group = factor(release), fill = factor(release), alpha = factor(release))) +
    geom_bar(stat = "count", position = "dodge", color = "grey") +
    theme_classic() +
    scale_fill_manual(values = c("#116530", "#116530")) +
    scale_alpha_discrete(range = c(2, 0.45)) ) 
...
(culture_figs[[3]] <- figure_data %>%
  ggplot(., aes(FamObligation, group = factor(release), fill = factor(release), alpha = factor(release))) +
    geom_bar(stat = "count", position = "dodge", color = "grey") +
    theme_classic() +
    scale_fill_manual(values = c("#116530", "#116530")) +
    scale_alpha_discrete(range = c(2, 0.45)) ) 
...
(culture_figs[[4]] <- figure_data %>%
  ggplot(., aes(FamReferent, group = factor(release), fill = factor(release), alpha = factor(release))) +
    geom_bar(stat = "count", position = "dodge", color = "grey") +
    theme_classic() +
    scale_fill_manual(values = c("#116530", "#116530")) +
    scale_alpha_discrete(range = c(2, 0.45)) ) 
...
(culture_figs[[5]] <- figure_data %>%
  ggplot(., aes(FamSupport, group = factor(release), fill = factor(release), alpha = factor(release))) +
    geom_bar(stat = "count", position = "dodge", color = "grey") +
    theme_classic() +
    scale_fill_manual(values = c("#116530", "#116530")) +
    scale_alpha_discrete(range = c(2, 0.45)) ) 
...
(culture_figs[[6]] <- figure_data %>%
  ggplot(., aes(IndepSelfReliance, group = factor(release), fill = factor(release), alpha = factor(release))) +
    geom_bar(stat = "count", position = "dodge", color = "grey") +
    theme_classic() +
    scale_fill_manual(values =c("#116530", "#116530")) +
    scale_alpha_discrete(range = c(2, 0.45)) ) 
...
(culture_figs[[7]] <- figure_data %>%
  ggplot(., aes(Religion, group = factor(release), fill = factor(release), alpha = factor(release))) +
    geom_bar(stat = "count", position = "dodge", color = "grey") +
    theme_classic() +
    scale_fill_manual(values = c("#116530", "#116530")) +
    scale_alpha_discrete(range = c(2, 0.45)) ) 
...
(culture_figs_arrange <- grid.arrange(grobs = culture_figs, ncol = 2) 
    )

ggsave('culture_figs.png', culture_figs_arrange, height = 9, width = 13)
...
for(i in 40:ncol(CombMeasures_resid)){
  
  cog_figs[[i-39]] <- ggplot(CombMeasures_resid) +
    geom_histogram(aes_string(colnames(CombMeasures_resid)[i])) +
    theme_classic()+
    theme(text = element_text(size = 5))
}

(cog_figs_arrange <- grid.arrange(grobs = cog_figs, ncol = 2) 
    )

ggsave('cog_figs.png', cog_figs_arrange, height = 9, width = 13)
```
