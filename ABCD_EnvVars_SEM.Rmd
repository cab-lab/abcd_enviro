...
variable_corrplot <- corrplot(variable_corr, method = 'color', type = "lower", diag = FALSE, p.mat =variable_corr_pvals$p, tl.pos = "n",
...
pc_corrplot <- corrplot(pc_corr, method = 'color', type = "lower", diag = FALSE, p.mat = pc_corr_pvals$p,
                              insig = "label_sig", cl.pos = "b", pch.col = "black", pch.cex = 2, outline = TRUE, addgrid.col = "gray",
