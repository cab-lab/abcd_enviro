...
culture_pca     <- PCA(CultureEnvVars_allcog, scale.unit = TRUE, graph = TRUE)

home_pca        <- PCA(HomeEnvVars_allcog, scale.unit = TRUE, graph = TRUE)

school_pca      <- PCA(SchoolEnvVars_allcog, scale.unit = TRUE, graph = TRUE)

neighborhood_pca <- PCA(NeighborhoodEnvVars_allcog, scale.unit = TRUE, graph = TRUE)

sociodem_pca    <- PCA(sem_cogdata[1:8], scale.unit = TRUE, graph = TRUE)

cog_pca         <- PCA(sem_cogdata[53:ncol(sem_cogdata)], scale.unit = TRUE, graph = TRUE)
